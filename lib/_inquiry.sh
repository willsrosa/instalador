...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao FlowFunil selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar FlowFunil\n"
  printf "   [1] Atualizar FlowFunil\n"
  printf "   [2] Deletar FlowFunil\n"
  printf "   [3] Bloquear FlowFunil\n"
  printf "   [4] Desbloquear FlowFunil\n"
  printf "   [5] Alter. dominio FlowFunil\n"
  printf "\n"
  read -p "> " option
