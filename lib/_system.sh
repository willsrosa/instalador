...
system_git_clone() {
  print_banner
  printf "${WHITE} 💻 Fazendo download do código FlowFunil...${GRAY_LIGHT}"
  printf "\n\n"
...
sudo su - deploy <<EOF
  git clone -b main https://github.com/willsrosa/flowfunil /home/deploy/${instancia_add}
EOF
...
system_update() {
  print_banner
  printf "${WHITE} 💻 Vamos atualizar o sistema Flow Funil...${GRAY_LIGHT}"
  printf "\n\n"
...
deletar_tudo() {
  print_banner
  printf "${WHITE} 💻 Vamos deletar o FlowFunil...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_bloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos bloquear o FlowFunil...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_desbloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos Desbloquear o FlowFunil...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_dominio() {
  print_banner
  printf "${WHITE} 💻 Vamos Alterar os Dominios do FlowFunil...${GRAY_LIGHT}"
  printf "\n\n"
